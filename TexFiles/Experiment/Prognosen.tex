...
~\newline Hierfür gibt es zwei mögliche Erklärungen: Die erste ist simples Overfitting.  

~\newline Eine Verbesserung der Genauigkeit hat sich ebenfalls durch das Erhöhen der Neuronenanzahl sowie der Anzahl der Epochen ergeben. Die in Netzdefinition genannten Einstellungen ergaben hierbei die kleinsten Werte mit gleichbleibender Genauigkeit.
\paragraph{Ergebnisse} ~\newline
\newpage

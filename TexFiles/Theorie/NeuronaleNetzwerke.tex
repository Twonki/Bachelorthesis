...
\end{center}
\end{figure}
~\newline Diese Neuronen werden zu einen Graphen, welche sich als \textit{Schichten} anordnen. 
...
Konkrete Anwendungen dieser Parameter und die damit zusammenhängende Ergebnisse finden sich im Kapitel \ref{cha:Experiment} dieser Arbeit.
...
\label{sec:NN}
Dieser Abschnitt widmet sich den Konzepten künstlicher Neuronaler Netze. Als Hauptquelle dient der Artikel von Selby \cite{SelbyNN} sowie die Vorlesung von Dr. Stroetmann \cite{stroetmann}.
...
Hierbei wird in gleichem Maße wie in der logistischen Regression vorgegangen, mit dem Unterschied das die Gewichte in einer Matrix vorliegen. Die vorgestellten Optimierungsverfahren finden hier ebenfalls Anwendung. 
...
~\newline Der Umfang dieses Trainings bleibt dem Anwender überlassen. Es ist möglich, bessere Ergebnisse zu erzielen, obwohl man mit denselben Daten häufiger trainiert. Einen solchen wiederholten Trainingsdurchlauf nennt man eine \textbf{Epoche}. 
...
\begin{itemize}
	...
	\item \textbf{Umfang der Trainingsdaten} 

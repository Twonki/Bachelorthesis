...
USE Taxi2Bachelor;
GO
DROP PROCEDURE IF EXISTS [dbo].[TrainPassengersNoSingleNN];
GO
CREATE PROCEDURE [dbo].[TrainPassengersNoSingleNN] 
@TrainingSize BigInt	
AS
BEGIN
	--=====================
	...
	INSERT INTO Models (timest,model,model_name)
		SELECT CURRENT_TIMESTAMP AS timest, model, 'NNPassengersNoSingle' AS name FROM #m;  
	DROP TABLE #m

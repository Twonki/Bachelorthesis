...
USE Taxi2Bachelor;
GO
DROP PROCEDURE IF EXISTS [dbo].[TrainPassengersFlatNN];
GO
CREATE PROCEDURE [dbo].[TrainPassengersFlatNN] 
@TrainingSize BigInt	
AS
BEGIN
	--=====================
	...
	INSERT INTO Models (timest,model,model_name)
		SELECT CURRENT_TIMESTAMP AS timest, model, 'NNPassengersFlat' AS name FROM #m;  
	DROP TABLE #m
